...
<style>
    ...
    *,*::before,*::after{box-sizing:border-box;}
    ...
    .btn.btn-primary{background:#5191fa;}
    ...
    .bravo_wrap .bravo_topbar .dropdown-menu li a{display:block;padding:8px 15px;color:#1a2b47;border-bottom:1px solid transparent;border-top:1px solid transparent;}
    ...
    .bravo_wrap .bravo_header .bravo-menu-mobile{width:300px;position:fixed;top:0;left:0;height:100%;background:#fff;transform:translate(-105%);transition:all .3s;z-index:20;border-right:1px solid #1a2b48;}
    @media (max-width:1023px){
    ...
    .bravo_wrap .bravo_header .bravo-menu-mobile .g-menu>ul>li a{color:#1a2b48;border-bottom:1px solid #e6e6e6;display:block;transition:all .3s;text-decoration:none;padding:10px 0;}
    .bravo_wrap .bravo_header .bravo-menu-mobile .g-menu>ul>li a:hover{border-bottom:1px solid #1a2b48;}
    .bravo_wrap .bravo_header .bravo-menu-mobile .g-menu>ul>li.active>a{border-bottom:1px dashed #1a2b48;}
    /*! CSS Used from: http://safar.com/new/custom-css.css */
    .text-primary{color:#5191fa!important;}
    .btn-primary,.btn-primary:disabled,.btn-primary:not(label.btn),.btn-primary:not([href]),.btn-primary:hover,.section-title:after{background-color:#5191fa!important;}
    .btn-primary,.btn-primary:disabled,.btn-primary:not(label.btn),.btn-primary:not([href]),.btn-primary:hover{border-color:#5191fa!important;}
